            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" wire:model.defer="name" id="name"
                           class="mt-1 block w-full border border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm rounded-md p-2 placeholder-neutral-400 dark:placeholder-neutral-500">
                ...
                <div>
                    ...
                    <textarea wire:model.defer="description" id="description" rows="4"
                              class="mt-1 block w-full border border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm rounded-md p-2 placeholder-neutral-400 dark:placeholder-neutral-500"></textarea>
                ...
                <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input id="requires_license_plate" wire:model.defer="requires_license_plate" type="checkbox"
                               class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-neutral-300 dark:border-neutral-600 rounded-sm bg-white dark:bg-neutral-700 checked:bg-neutral-900 dark:checked:bg-blue-500">
                    </div>
