    ...
    <div class="space-y-4">
        ...
        <div>
            ...
            <select wire:model.defer="brand_id" id="brand_id"
                    class="mt-1 block w-full border {{ $errors->has('brand_id') ? 'border-red-500' : 'border-neutral-300 dark:border-neutral-600' }} bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm rounded-none p-2 appearance-none">
