            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" wire:model.defer="name" id="name"
                           class="block w-full border {{ $errors->has('name') ? 'border-red-500' : 'border-neutral-300 dark:border-neutral-600' }} bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-200 shadow-xs focus:border-blue-500 focus:ring-blue-500 sm:text-sm rounded-md p-2 placeholder-neutral-400 dark:placeholder-neutral-500">
                ...
                <div>
                    ...
                    <input type="email" wire:model.defer="email" id="email"
                           class="block w-full border {{ $errors->has('email') ? 'border-red-500' : 'border-neutral-300 dark:border-neutral-600' }} bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-200 shadow-xs focus:border-blue-500 focus:ring-blue-500 sm:text-sm rounded-md p-2 placeholder-neutral-400 dark:placeholder-neutral-500">
                ...
                <div>
                    ...
                    <select wire:model.defer="role" id="role"
                            class="block w-full border {{ $errors->has('role') ? 'border-red-500' : 'border-neutral-300 dark:border-neutral-600' }} bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-200 shadow-xs focus:border-blue-500 focus:ring-blue-500 sm:text-sm rounded-md p-2 appearance-none">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="password" wire:model.defer="password" id="password"
                           class="block w-full border {{ $errors->has('password') ? 'border-red-500' : 'border-neutral-300 dark:border-neutral-600' }} bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-200 shadow-xs focus:border-blue-500 focus:ring-blue-500 sm:text-sm rounded-md p-2">
                ...
                <div>
                    ...
                    <input type="password" wire:model.defer="password_confirmation" id="password_confirmation"
                           class="block w-full border {{ $errors->has('password_confirmation') ? 'border-red-500' : 'border-neutral-300 dark:border-neutral-600' }} bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-200 shadow-xs focus:border-blue-500 focus:ring-blue-500 sm:text-sm rounded-md p-2">
